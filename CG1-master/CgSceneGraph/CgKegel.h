...
class CgKegel : public CgBaseTriangleMesh {

public:
    CgKegel(int id);
    CgKegel(int id, int anzahl_kreispunkte, int anzahl_hoehe, double hoehe);
    ~CgKegel();
    void punkte();
    void kreisflaeche();
    void mantelflaeche();
    ...
    inline Cg::ObjectType CgKegel::getType() const {return m_type;}
    inline unsigned int CgKegel::getID() const {return m_id;}
