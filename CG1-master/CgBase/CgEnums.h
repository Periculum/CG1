...
namespace Cg{
    ...
    CgColorChangedEvent             = 0x00010000,   //Enum für Color Change Event
    CgUnterteilungsEvent            = 0x00020000,

    WindowResizeEvent               = 0x0000100,

    // unused, may be changed to whatever
    //CgSomeSpecialEvent1             = 0x0001000,  //used for ColorChangeEvent
    //CgSomeSpecialEvent2             = 0x0002000,  //used for Unterteilung
